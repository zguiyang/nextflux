export default {
  ...
  settings: {
    ...
    ai: {
      title: "AI",
      description: "Supports OpenAI and OpenAI-compatible APIs. Requests are sent directly from your browser, so the provider must allow CORS.",
      ...
      modelDescription: "Platforms that support /models will provide a list. You can enter a model name manually if fetching fails.",
      modelsLoaded: "{{count}} models loaded",
      noModels: "The model list is empty. Enter a model name manually.",
