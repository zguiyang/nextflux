export default {
  ...
  articleList: {
    ...
    all: "全部",
    sort: "排序",
    sortPublishedDesc: "发布时间倒序",
    sortPublishedAsc: "发布时间正序",
  ...
  articleView: {
    ...
    bilingualSameLanguageAsSystem: "此文章不用翻译，已与系统语言保持一致",
  ...
  settings: {
    ...
    general: {
      ...
      articleList: "文章列表",
      sort: "排序",
      sortPublishedDesc: "按发布时间倒序",
      sortPublishedAsc: "按发布时间正序",
      sortCreatedDesc: "按创建时间倒序",
      sortCreatedAsc: "按创建时间正序",
      sortItems: "排序",
      sortDesc: "新文章优先",
      sortAsc: "旧文章优先",
      sortField: "排序字段",
