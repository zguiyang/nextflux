export default {
  ...
  settings: {
    ...
    ai: {
      title: "AI",
      description: "目前仅支持 OpenAI 及兼容 OpenAI 格式的 API。请求由浏览器直接发出，服务商需要允许跨域（CORS）。",
      openai: "OpenAI 配置",
      apiKey: "API Key",
      ...
      selectModel: "选择模型",
      fetchModels: "获取模型",
      modelDescription: "支持的平台会从 /models 获取列表；如果获取失败，可以直接填写模型名称。",
      modelsLoaded: "已获取 {{count}} 个模型",
      noModels: "接口返回的模型列表为空，请手动填写模型名称",
